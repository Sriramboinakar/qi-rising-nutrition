...
export default async function ReportsPage() {
  const [statusGroups, categoryGroups, programGroups, latestCheckIns, overdueCount, monthsGrowth, totalClients] =
    await Promise.all([
  ...
  const monthKeys = sixMonths.map((m, i) => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="p-5">
          ...
          <p className="mt-1 text-3xl font-semibold text-stone-900">{totalClients}</p>
        </Card>
        <Card className="p-5">
        ...
        <Card className="p-5">
          ...
          <p className="mt-1 text-3xl font-semibold text-stone-900">{overdueCount}</p>
        </Card>
      </div>
